        ...
        >
          ...
          >
            ...
            <button
              ...
              className="px-8 py-3 bg-gray-800/50 border border-gray-700 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors duration-300 flex items-center justify-center"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <button
                ...
                className="px-6 py-3 bg-gray-800 border border-gray-700 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors duration-300 flex items-center"
              >
