...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white dark:from-gray-900 dark:to-gray-800 font-sans p-4">
      <div className="container mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-100 dark:bg-gray-800/50 p-4 rounded-xl">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Free Storage</div>
                  </div>
                  <div className="bg-gray-100 dark:bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#f1c40f] font-bold text-2xl mb-1">
                      2GB
                    </div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Max File Size</div>
                  </div>
                  <div className="bg-gray-100 dark:bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#9b59b6] font-bold text-2xl mb-1">
                      256-bit
                    </div>
                    <div className="text-gray-600 dark:text-gray-400 text-sm">Encryption</div>
                  </div>
                  <div className="bg-gray-100 dark:bg-gray-800/50 p-4 rounded-xlbg-gray-800/50 p-4 rounded-xl">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {featureCards.map((feature, index) => (
                  ...
                  >
                    <div
                      className="p-3 rounded-lg mb-4 inline-block group-hover:scale-110"
              ...
              <div className="bg-gradient-to-r from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-gray-900 dark:text-white font-bold">Security Features</h4>
                </div>
              ...
              <div className="bg-white/70 dark:bg-gray-800/30 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                <h4 className="text-gray-900 dark:text-white font-bold mb-4">Trusted by Teams</h4>
        ...
        {/* Footer */}
        <footer className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-600 dark:text-gray-500 text-sm">
          <p>
