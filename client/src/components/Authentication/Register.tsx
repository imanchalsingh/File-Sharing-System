...
const Register: React.FC = () => {
  ...
  const passwordStrength = () => {
    ...
    if (password.length < 6) return { width: "33%", color: "#e74c3c", text: "Weak" };
    if (password.length < 10) return { width: "66%", color: "#f1c40f", text: "Medium" };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 font-sans p-4">
      <div className="container mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="mt-3 space-y-1">
                    <li className={`flex items-center text-sm ${password.length >= 6 ? 'text-[#2ecc71]' : 'text-gray-500'}`}>
                      <Check className={`w-4 h-4 mr-2 ${password.length >= 6 ? 'opacity-100' : 'opacity-0'}`} />
                ...
                <div className="text-center text-gray-400 text-sm">
                  ...
                  <a href="#" className="text-[#3498db] hover:underline">Terms of Service</a>{" "}
                  and{" "}
                  <a href="#" className="text-[#3498db] hover:underline">Privacy Policy</a>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 shadow-2xl">
                <div className="flex items-start mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-2">SecureShare</h3>
                    <p className="text-gray-400">
                      A modern file sharing system with enterprise-grade security and blazing fast transfers.
                      Share files securely with end-to-end encryption and real-time collaboration.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#2ecc71] font-bold text-2xl mb-1">10GB</div>
                    <div className="text-gray-400 text-sm">Free Storage</div>
                  </div>
                  <div className="bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#f1c40f] font-bold text-2xl mb-1">2GB</div>
                    <div className="text-gray-400 text-sm">Max File Size</div>
                  </div>
                  <div className="bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#9b59b6] font-bold text-2xl mb-1">256-bit</div>
                    <div className="text-gray-400 text-sm">Encryption</div>
                  </div>
                  <div className="bg-gray-800/50 p-4 rounded-xl">
                    <div className="text-[#e74c3c] font-bold text-2xl mb-1">99.9%</div>
              ...
              <div className="bg-gray-800/30 rounded-2xl p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-gray-300 text-sm">"The security and speed are unmatched. Perfect for our remote team."</p>
                      <p className="text-gray-500 text-xs mt-1">- Sarah, Project Manager</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-10 h-10 bg-gradient-to-r from-[#9b59b6] to-[#3498db] rounded-full mr-3"></div>
                    <div>
                      <p className="text-gray-300 text-sm">"Switched from Dropbox and never looked back. Encryption gives us peace of mind."</p>
                      <p className="text-gray-500 text-xs mt-1">- Mark, Startup Founder</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <footer className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© 2024 SecureShare. All files are encrypted before leaving your device.</p>
          <p className="mt-1 text-gray-600">File sharing made secure and simple.</p>
        </footer>
      </div>
    </div>
  );
